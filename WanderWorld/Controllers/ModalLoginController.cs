...
using WanderWorld.Context;
using WanderWorld.Infrastructure.Concrete;
using WanderWorld.ModalLogin;
using WanderWorld.ModalLogin.Abstract;
using WanderWorld.ModalLogin.Models;

namespace WanderWorld.Controllers
{
                ...
                if (user != null)
                {
                    ...
                    if (db.SaveChanges() > 0)
                    {
                        bool sent = mailer.SendMail(
                            ...
                            user.Email, "WanderWorld - Şifre Sıfırlama", true);
